...
class ClickSettingsLayer : public xdbot::Popup<std::string, xdbot::Popup<>*> {
...
private:
    ...
    bool setup(std::string button, xdbot::Popup<>* layer) override;

public:

    xdbot::Popup<>* clickbotLayer = nullptr;

    static ClickSettingsLayer* create(std::string button, xdbot::Popup<>* layer);
...
class ClickbotLayer : public xdbot::Popup<> {
...
public:
    ...
    void openClickSettings(CCObject* obj) {
        ...
        ClickSettingsLayer::create(id, static_cast<xdbot::Popup<>*>(this))->show();
    }
